    ...
    <section class="result">
          <swiper class="swiper" ref="mySwiper" :options="swiperOptions">
            <swiper-slide class="weather__item" :key="slide.name" v-for="slide in weatherResult">
                ...
                <div v-if="slide.weather[0].main === 'Snow'" class="icon flurries">
                    <div class="cloud"></div>
                    <div class="snow">
                        <div class="flake"></div>
                        <div class="flake"></div>
                ...
                <div v-if="slide.weather[0].main === 'Clear'" class="icon sunny">
                <div class="sun">
                    <div class="rays"></div>
                </div>
                </div>

                <div v-if="slide.weather[0].main === 'Rain'" class="icon rainy">
                    <div class="cloud"></div>
                    <div class="rain"></div>
                </div>
                <p class="weather__item__temp">{{slide.temp.day | filterTemp}}&deg;C</p>
            </swiper-slide>
  ...
  export default {
    ...
    filters: {
        parseDate(UTCstr) {
            ...
            return new Date(UTCstr * FIX_WRONG_UTC).toLocaleString('ru', formatter);
        },
        filterTemp(temp) {
            if (Math.sign(temp) === 1) {
            ...
            // const isAboveZero = Math.sign(temp);

            // isAboveZero ? `+${temp.toFixed(1)}` : temp.toFixed(1);
        }
    }
  }
</script>
